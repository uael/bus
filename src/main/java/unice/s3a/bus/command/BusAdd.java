 ...
 * The type Bus add.
 */
@Command(name = "add", description = "create new buses")
public class BusAdd extends BbusCommand {
    /**
     * The Names.
     */
    ...
    public Object call() throws Exception {
        ...
        for (String name : this.names) {
            ...
            Bbus.busMap.put(name, new Bus(name));
        }
        Bbus.save();

        return new Response("Successfully added buses "+String.join(", ", names)+".");
    }
}
